            ...
            <li class="nav-item active">
                ...
                <div id="collapsePages" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="conductor.php">Conductor</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-center text-gray-900">Registro de Conductores</h1>

                    <!-- Row -->
                    <!-- MENSAJE LUEGO DE GUARDAR CONDUCTOR -->
                    ...
                    <div class="card card-body form_reducir text-gray-900 mb-4">
                        <form action="../crud/guardar_conductor.php" method="POST">
                            <div class="row form-group">
                                <div class="col-md-4">
                                    <label for="inputNombre" class="form-label ">Nombre</label>
                                    <input name="nombre_c" type="text" class="form-control" id="inputNombre" required>
                                </div>
                                <div class="col-md-4">
                                    <label for="inputApellido" class="form-label">Apellido</label>
                                    <input name="apellido_c" type="text" class="form-control" id="inputApellido" required>
                                </div>
                                <div class="col-md-4">
                                    <label for="inputDireccion" class="form-label">Direccion</label>
                                    <input name="direccion_c" type="text" class="form-control" id="inputDireccion" required>
                                </div>
                            ...
                            <div class="row py-2 form-group">
                                <div class="col-md-3">
                                    ...
                                    <input name="telefono_c" type="tel" class="form-control" id="inputTel" required>
                                </div>
                                <div class="col-md-3">
                                    <label for="inputCorreo" class="form-label">Correo</label>
                                    <input name="email_c" type="email" class="form-control" id="inputCorreo" required>
                                </div>
                                <div class="col-md-3">
                                    <label for="inputLic" class="form-label">Licencia</label>
                                    <input name="licencia_c" type="text" class="form-control" id="inputLic" required>
                                </div>
                                <div class="col-md-3">
                                    <label for="inputSalario" class="form-label">Salario</label>
                                    <input name="salario_c" type="number" class="form-control" id="inputSalario" required>
                                </div>
                            </div>
                            <div class="row">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Listado de conductores</h6>
                        </div>
                        <div class="card-body">
                                        ...
                                        while ($row = mysqli_fetch_array($resultado)) { ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="../crud/editar_conductor.php?id=<?php echo $row['id'] ?>" class="btn btn-secondary">
                                                        <i class="far fa-edit"></i>
                                                    </a>
                                                    <a href="../crud/eliminar_conductor.php?id=<?php echo $row['id'] ?>" class="btn btn-danger">
