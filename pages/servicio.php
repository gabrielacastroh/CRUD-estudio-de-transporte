			...
			<li class="nav-item active">
				...
				<div id="collapsePages" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item active" href="servicio.php">Servicio</a>
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<h1 class="h3 text-center mb-4 text-gray-800">Registro de Servicios</h1>
					...
					<div class="card card-body form_servicio text-gray-900 mb-4">
						<form action="../crud/guardar_servicio.php" method="POST">
							<div class="row justify-content-center form-group">
								<div class="col-md-7 mb-3 my-2">
									<label for="inputPrecio" class="form-label">Precio</label>
									<input name="precio_s" type="number" class="form-control" id="inputPrecio" required>
								</div>
							...
							<div class="row justify-content-center form-group">
								<div class="col-md-7">
									...
									<textarea name="descripcion_s" class="form-control" id="inputDesc" cols="20" rows="5" required></textarea>
								</div>
							</div>
							<div class="row">
										...
										while ($row = mysqli_fetch_array($resultado)) { ?>
											<tr>
												...
												<td class="text-center">
													<a href="../crud/editar_servicio.php?id=<?php echo $row['id'] ?>" class="btn btn-secondary">
														<i class="far fa-edit"></i>
													</a>
													<a href="../crud/eliminar_servicio.php?id=<?php echo $row['id'] ?>" class="btn btn-danger">
