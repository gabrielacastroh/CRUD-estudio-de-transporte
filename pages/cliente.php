			...
			<li class="nav-item active">
				...
				<div id="collapsePages" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item active" href="cliente.php">Cliente</a>
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<h1 class="h3 mb-4 text-center text-gray-900">Registro Cliente</h1>
						...
						<form action="../crud/guardar_cliente.php" method="POST">
							<div class="row form-group justify-content-center">
								<div class="col-md-5">
									...
									<input name="nombre_cl" type="text" class="form-control" id="inputNombre" required>
								</div>
								<div class="col-md-5">
									<label for="inputApellido" class="form-label">Apellido</label>
									<input name="apellido_cl" type="text" class="form-control" id="inputApellido" required>
								</div>
							</div>
							<div class="row py-2 form-group justify-content-center">
								<div class="col-md-3">
									<label for="inputDireccion" class="form-label">Direccion</label>
									<input name="direccion_cl" type="text" class="form-control" id="inputDireccion" required>
								</div>
								<div class="col-md-3">
									<label for="inputTel" class="form-label">Teléfono</label>
									<input name="telefono_cl" type="tel" class="form-control" id="inputTel" required>
								</div>
								<div class="col-md-4">
									<label for="inputCorreo" class="form-label">Correo</label>
									<input name="email_cl" type="email" class="form-control" id="inputCorreo" required>
								</div>
							</div>
							<div class="row">
										...
										while ($row = mysqli_fetch_array($resultado)) { ?>
											<tr>
												...
												<td class="text-center">
													<a href="../crud/editar_cliente.php?id=<?php echo $row['id'] ?>" class="btn btn-secondary">
														<i class="far fa-edit"></i>
													</a>
													<a href="../crud/eliminar_cliente.php?id=<?php echo $row['id'] ?>" class="btn btn-danger">
