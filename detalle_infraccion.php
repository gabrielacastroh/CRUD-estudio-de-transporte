			...
			<li class="nav-item active">
				...
				<div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item active" href="detalle_infraccion.php">Reporte Infracción</a>
					</div>
				</div>
			</li>
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<h1 class="h3 my-5 text-center text-gray-900">Reporte de Infracciones</h1>
					...
					<div class="card card-body form_reducir text-gray-900 my-5 col-md-7">
						<form action="tabla_pdf.php" method="POST">
							<div class="col-md">
								<label for="inputInfraccion" class="form-label h5">Infracción</label>
								<select name="id_infraccion" id="inputInfraccion" class="form-select form-select-md" required>
									<option value="" selected>-- Seleccione el ID de la infracción--</option>

									<!-- CONSULTA CLIENTE-->
									<?php
									$query = "SELECT id  FROM infracciones ORDER BY id ASC";
							...
							<div class="row mt-3">
								<div class="col-md-2 m-auto">
									<input type="submit" value="Generar PDF" class="btn btn-primary " name="generar">
								</div>
							</div>
						</form>
					</div>
