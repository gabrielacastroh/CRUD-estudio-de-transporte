                                ...
                                <div class="card border-left-primary shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <h5 class="mb-2 font-weight-bold text-primary text-uppercase mb-1">Conductores</h5>
                                                <div class=" mb-0 font-weight-bold text-gray-900 text-xs ">Ingresar, Actualizar y Eliminar conductores</div>
                                            </div>
                                            <div class="col-auto">
                                    ...
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <div class=" mb-0 font-weight-bold text-gray-900 text-xs ">Ingresar, Actualizar y Eliminar clientes</div>
                                            </div>
                                            <div class="col-auto">
                                    ...
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <div class=" mb-0 font-weight-bold text-gray-900 text-xs ">Ingresar, Actualizar y Eliminar vehiculos</div>
                                            </div>
                                            <div class="col-auto">
